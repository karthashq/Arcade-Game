...
var Engine = (function(global) {
   ...
   function renderEntities() {
      ...
      if (player.reached >= 15) {
         ...
         ctx.lineWidth = 4;
         ctx.strokeText("You won!!!", 150, 300);
         ctx.fillText("You won!!!", 150, 300);
         ctx.font = "20px Impact";
         ctx.strokeText("Press enter to restart...", 150, 350);
         ctx.fillText("Press enter to restart...", 150, 350);
      ...
      //to display the player has lost the game.
      if (player.lives < 1) {
         ...
         ctx.strokeStyle = "Black";
         ctx.lineWidth = 4;
         ctx.strokeText("You Lost!!!", 150, 300);
